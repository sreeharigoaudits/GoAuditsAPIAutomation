...
public class GetPdf {
    ...
    public GetPdf(Common_Actions actions) {
     ...
     */
    @Step("Get Pdf")
    public void perform(String uid, String guid, String client_id, String audit_type_id, String audit_date,String store_id,String seq_no,String timezone,String end_date, Authenticable auth, boolean assertPositiveResponse) throws Exception {
        ...
        client.post("api/audits/report/getpdf");
    ...
    public void perform(Authenticable auth) throws Exception {
        perform(Runtime_DataHolder.getUID(), Runtime_DataHolder.getGUID(), Runtime_DataHolder.getCompanyID(), Runtime_DataHolder.getAuditNameID(),  DateUtils.getCurrentDate(),Runtime_DataHolder.getLocationID(),Runtime_DataHolder.getSeqNo(),"Asia/Calcutta",DateUtils.getCurrentDateTime(), auth, true);
