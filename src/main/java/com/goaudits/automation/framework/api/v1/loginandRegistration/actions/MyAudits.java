...
public class MyAudits {
    ...
    public void perform(String uid, String guid, String status, Authenticable auth, boolean assertPositiveResponse) throws Exception {
        ...
        client.body().put("status", status);
        client.post("api/audits/myaudits/list");
    ...
    public void perform(Authenticable auth) throws Exception {
        perform(Runtime_DataHolder.getUID(), Runtime_DataHolder.getGUID(), "1,2,3,4", auth, true);
